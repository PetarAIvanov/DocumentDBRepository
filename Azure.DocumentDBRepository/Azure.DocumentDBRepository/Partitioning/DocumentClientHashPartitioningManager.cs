namespace Azure.DocumentDBRepository.Partitioning
{
    using System;
    ...
    {
        private string collectionIdPrefix { get; set; }
            ...
            TransitionReadMode readMode = TransitionReadMode.ReadBoth)
        {
            ...
            this.Client.PartitionResolvers[database.SelfLink] = new ManagedHashPartitionResolver(partitionKeyExtractor, client, database, 
                initialPartitionCount, collectionIdPrefix: collectionIdPrefix);
